...
def generate_models(x, y, degs):
    ...
    fitted_polynomials = []
    for deg in degs:
        fitted_polynomial = pylab.polyfit(x, y, deg)
...
def gen_cities_avg(climate, multi_cities, years):
    ...
    for year in years:
        ...
        for city in multi_cities:
            city_avg_temp = climate.get_yearly_temp(city, year).mean()
            city_temps.append(city_avg_temp)
        avg_natl_temp = pylab.array(city_temps).mean()
